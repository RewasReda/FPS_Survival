...
public class AnimationTags
{
    ...
    public const string HUNTING_RIFLE_IN = "HuntingRifleAnimIn";
    public const string HUNTING_RIFLE_OUT = "HuntingRifleAnimOut";
...
public class Tags
{
    ...
    public const string Scene_Tag = "SampleScene";
